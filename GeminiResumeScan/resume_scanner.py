...
# For Reading Resumes (PDF & DOCX)
from PyPDF2 import PdfReader
import docx

# For querying Gemini LLM
...
def analyze_resume(text):
    ...
    """
    prompt_template = """
    You are a professional resume scanner. Given the following resume text, extract the most relevant information and structure it in this JSON format (The output must be in JSON):
    {
    ...
    Resume Text: \n
    """
    text = re.sub("\s{4,}"," ",text) # Remove any unnecessary spaces/formatting
