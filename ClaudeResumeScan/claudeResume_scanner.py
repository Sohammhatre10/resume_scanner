...
def analyze_resume_with_claude(text):
    """
    Analyze the given resume text using Claude and structure it into JSON format.
...
def process_resume(file_path):
    ...
    structured_output = analyze_resume_with_claude(text)
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python claude_handler.py <path_to_resume_file>")
        sys.exit(1)
